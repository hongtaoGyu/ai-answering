...
export async function selectOptionDetailActivatedData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDetailActivatedDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/activatedData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionDetailCreateData(
  ...
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/createData', {
    method: 'POST',
    headers: {
...
export async function selectOptionDetailDeactivatedData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDetailDeactivatedDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/deactivatedData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionDetailDeleteData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDetailDeleteDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/deleteData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionDetailGetData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDetailGetDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/getData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionDetailGetDataList(
  ...
  return request<API.BaseResponsePageSelectOptionDetail_>('/api/selectOptionDetail/getDataList', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function selectOptionDetailUpdateData(
  ...
  return request<API.BaseResponseSelectOptionDetailVO_>('/api/selectOptionDetail/updateData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
