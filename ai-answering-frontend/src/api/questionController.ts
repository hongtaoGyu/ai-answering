...
export async function questionSaveOrUpdateData(
  ...
  return request<API.BaseResponseQuestionVO_>('/api/question/saveOrUpdateData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function questionUpdateData(body: API.QuestionVO, options?: { [key: string]: any }) {
