...
export async function userGet( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function userGetVo( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function userListPageVo(
  body: API.UserQueryRequest,
  options?: { [key: string]: any }
) {
...
export async function userLoginWxOpen( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
