...
export async function selectOptionActivatedData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionActivatedDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/activatedData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionCreateData(
  ...
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/createData', {
    method: 'POST',
    headers: {
...
export async function selectOptionDeactivatedData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDeactivatedDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/deactivatedData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionDeleteData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.selectOptionDeleteDataParams,
  options?: { [key: string]: any },
) {
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/deleteData', {
    method: 'GET',
    params: {
      ...params,
    },
...
export async function selectOptionGetData(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function selectOptionGetDataList(
  ...
  return request<API.BaseResponsePageSelectOption_>('/api/selectOption/getDataList', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function selectOptionGetSelectOptionDataByName(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function selectOptionSaveOrUpdateData(
  ...
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/saveOrUpdateData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
export async function selectOptionUpdateData(
  ...
  return request<API.BaseResponseSelectOptionVO_>('/api/selectOption/updateData', {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
