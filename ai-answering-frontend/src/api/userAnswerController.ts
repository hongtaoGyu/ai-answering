...
export async function userAnswerActivatedData( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function userAnswerDeactivatedData( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  ...
  return request<API.BaseResponseUserAnswerVO_>(
    "/api/userAnswer/deactivatedData",
    {
      method: "GET",
      params: {
        ...params,
...
export async function userAnswerDeleteData( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function userAnswerGetData( // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
...
export async function userAnswerSaveOrUpdateData(
  ...
  return request<API.BaseResponseUserAnswerVO_>(
    "/api/userAnswer/saveOrUpdateData",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
