...
import API from "@/api";
import { userAnswerGetUserAnswerWithUser } from "@/api/userAnswerController";
...
const data = ref<API.UserAnswerWithUserVO>({});
...
const loadData = async () => {
  ...
  const res = await userAnswerGetUserAnswerWithUser({
    id: props.id as any,
  });
  if (res.data.code === 0) {
