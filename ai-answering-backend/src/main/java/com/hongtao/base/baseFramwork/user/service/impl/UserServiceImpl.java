package com.hongtao.base.baseFramwork.user.service.impl;
...
import com.hongtao.base.baseFramwork.user.dao.UserMapper;
import com.hongtao.base.baseFramwork.user.model.entity.User;
import com.hongtao.base.baseFramwork.user.model.enums.UserRoleEnum;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
     ...
     * 盐值，混淆密码
     */
    public static final String SALT = "hongtao";
...
//        request.getSession().setAttribute(USER_LOGIN_STATE, user);
    ...
    public User getLoginUser() {
        ...
        User currentUser = getById(Long.parseLong(userObj.toString()));
        if (currentUser == null) {
            throw new BusinessException(ErrorCode.NOT_LOGIN_ERROR);
        }
        return currentUser;
